...
public class ConstFold implements ast.Visitor
{
  ...
  public void visit(Lt e)
  {
	  ...
	  if(e.left instanceof Exp.Num && e.right instanceof Exp.Num){
		  Main.isChanged = true;
		  if(((Exp.Num)e.left).num < ((Exp.Num)e.right).num){
			  this.exp = new True(e.lineNum);
			  return;
		  }else{
			  this.exp = new False(e.lineNum);
		  }
	  }
  ...
  public void visit(ProgramSingle p)
  {
    ...
    if (control.Control.trace.getLast().equals("ast.ConstFold")){
